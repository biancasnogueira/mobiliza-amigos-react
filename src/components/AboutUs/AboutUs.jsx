    ...
    <section className="sobre-nos">
      <div className="conteudo-sobre-nos">
        ...
        <p>
          ...
          Em apenas quatro anos de atuação, já transformamos a vida de <span id="contador" className="contador">0</span> crianças, conectando sonhos e inspirando ações através do poder do voluntariado.
        </p>
        <blockquote>
